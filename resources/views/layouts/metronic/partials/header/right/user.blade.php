<!--begin::Menu wrapper-->
<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'click'}"
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
    ...
    <div class="menu-item px-5 my-1">
        <a class="menu-link px-5" href="../../demo1/dist/account/settings.html">Account Settings</a>
    </div>
    <!--end::Menu item-->
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <form method="POST" action="{{ route('logout') }}" class="menu-link px-5" x-data>
            @csrf
            <button href="#" class="btn btn-link menu-link px-5" type="submit">Sign Out</button>
        </form>
    </div>
